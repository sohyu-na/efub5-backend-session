...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -242871190L;
    ...
    public final com.practice.blog.post.domain.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.practice.blog.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
